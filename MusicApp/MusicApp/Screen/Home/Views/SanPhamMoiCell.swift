...
class SanPhamMoiCell: UITableViewCell {
...
//    private let itemsPerRow: CGFloat = 2
    ...
    override func awakeFromNib() {
        ...
        collectionView.registerCellNib(SanPhamMoiCollectionViewCell.self)
    }
...
extension SanPhamMoiCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
